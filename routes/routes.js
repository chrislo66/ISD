...
router.get('/student/:studentid/goal/:goalid/goaldata_edit/:goaldataid', goaldata_controller.goaldata_edit);
router.get('/student/:studentid/delete', student_controller.student_delete); //TODO: deletes goal from datapoint
//router.get('/student/:studentid/goal/:goalid/goaldata/goaldata_edit', goaldata_controller.goaldata_redirect_edit)
//router.post('/student/:studentid/goal/:goalid/goaldata_edit/submit', goaldata_controller.goaldata_edit); //submit final student edits
...
router.get('/student/:studentid/goal/:goalid/edit', goal_controller.navigate_to_goalProfileEdit); // navigates to a goal within a student profile
router.get('/student/:studentid/goal/:goalid', goal_controller.navigate_to_goalProfile); // navigates to a goal within a student profile after editing
